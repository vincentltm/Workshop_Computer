...
protected:
	...
	bool isADCStopped() const
	{
		return runADCMode == RUN_ADC_MODE_ADC_STOPPED;
	}
	bool processSampleRunning = false;
...
void __not_in_flash_func(ComputerCard::AudioWorker)()
{
	...
	while (1)
	{
		...
		{
			// break;
			continue; // Wait until restart is requested
		}
	}
}
